...
const TEXTOS = {
    ...
    ERRO_TENTATIVAS: 'Por motivos de segurança, vou precisar encerrar este atendimento por causa das várias tentativas. Mas não se preocupe! Daqui a pouco o senhor(a) pode tentar de novo mandando um "Oi".',
